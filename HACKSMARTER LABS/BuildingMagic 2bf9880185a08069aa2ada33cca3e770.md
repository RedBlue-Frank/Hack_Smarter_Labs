...
![image.png](<../.gitbook/assets/image 7 (12).png>)
...
*   There is an interesting `File-share` that we need to dig into.
    ...
    ![image.png](<../.gitbook/assets/image 8 (12).png>)
...
![image.png](<../.gitbook/assets/image 12 (11).png>)
...
![image.png](<../.gitbook/assets/image 13 (11).png>)
...
![image.png](<../.gitbook/assets/image 15 (10).png>)
...
*   `File-Share` could contain creds, scripts, config files, automation logs, GPO paths
    ...
    ![image.png](<../.gitbook/assets/image 16 (10).png>)
...
*   `h.potch` **now has the golden ticket** into `File-Share` \*with `write access*.`
    ...
    ![image.png](<../.gitbook/assets/image 20 (10).png>)
...
![image.png](<../.gitbook/assets/image 26 (10).png>)
...
![image.png](<../.gitbook/assets/image 27 (10).png>)

```bash
impacket-secretsdump -sam SAM -system SYSTEM LOCAL
```

![image.png](<../.gitbook/assets/image 28 (9).png>)
...
![image.png](<../.gitbook/assets/image 29 (9).png>)
