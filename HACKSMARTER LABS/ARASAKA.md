...
![image.png](ARASAKA/image%201.png)
...
![image.png](ARASAKA/image%202.png)
...
![image.png](ARASAKA/image%203.png)

- Only the user `faraday` uses the password `hacksmarter123`

### Enumerating for pre-created computer accounts

![image.png](ARASAKA/image%204.png)

- No pre-created computer account

### Enumerating for `certificate services`

![image.png](ARASAKA/image%205.png)
...
![image.png](ARASAKA/image%206.png)
...
![image.png](ARASAKA/image%2011.png)
...
![image.png](ARASAKA/image%2012.png)
...
![image.png](ARASAKA/image%2013.png)

![image.png](ARASAKA/image%2014.png)
...
![image.png](ARASAKA/image%2015.png)
...
- We can probably get our `user-flag` ***HOPEFULLY.***
...
![image.png](ARASAKA/image%2016.png)
...
![image.png](ARASAKA/image%2017.png)
...
*I went down a rabbit hole so deep even BloodHound asked if I needed help. LOL*

- We still have one more hope - CA

## Enumerating and Compromising CA

![image.png](ARASAKA/image%2018.png)
...
![image.png](ARASAKA/image%2019.png)

![image.png](ARASAKA/image%2020.png)
...
![image.png](ARASAKA/image%2021.png)
...
![image.png](ARASAKA/image%2022.png)
...
- Attempting to crack the hash
    ...
    ![image.png](ARASAKA/image%2023.png)
...
![image.png](ARASAKA/image%2024.png)
...
![image.png](ARASAKA/image%2025.png)

![image.png](ARASAKA/image%2026.png)
...
![image.png](ARASAKA/image%2027.png)

![image.png](ARASAKA/image%2028.png)
...
![image.png](ARASAKA/image%2029.png)
...
![image.png](ARASAKA/image%2030.png)
...
![image.png](ARASAKA/image%2031.png)
...
![image.png](ARASAKA/image%2032.png)
...
![image.png](ARASAKA/image%2033.png)
